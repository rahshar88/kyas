...
${SUPABASE} functions deploy redeem-invite submit-registration admin-review-registration admin-console ensure-referral-code request-account-deletion --project-ref "${PROJECT_REF}"
